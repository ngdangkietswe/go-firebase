    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SendPasswordResetMailRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/{id}/en-disable": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Enable/Disable User Info",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.EnDisableUserRequest"
                        }
                    }
                ],
                "responses": {
