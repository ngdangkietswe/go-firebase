...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case permission.FieldCreatedBy, permission.FieldUpdatedBy, permission.FieldDeletedBy:
			values[i] = &sql.NullScanner{S: new(uuid.UUID)}
		case permission.FieldDeleted:
			values[i] = new(sql.NullBool)
		case permission.FieldAction, permission.FieldResource, permission.FieldDescription:
