...
func (_q *DeviceTokenQuery) QueryUser() *UserQuery {
...
func (_q *DeviceTokenQuery) WithUser(opts ...func(*UserQuery)) *DeviceTokenQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *DeviceTokenQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*DeviceToken, init func(*DeviceToken), assign func(*DeviceToken, *User)) error {
...
func (_q *DeviceTokenQuery) ForUpdate(opts ...sql.LockOption) *DeviceTokenQuery {
...
func (_q *DeviceTokenQuery) ForShare(opts ...sql.LockOption) *DeviceTokenQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
